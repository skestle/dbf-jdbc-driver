...
public class DbfH2Connection implements Connection{
    public final File dbfFolder;
    public final H2WrappedConnection wrappedConnection;

    public DbfH2Connection(File dbfFolder, H2WrappedConnection wrappedConnection) {
        this.dbfFolder = dbfFolder;
        this.wrappedConnection = wrappedConnection;
    }

    /** Extracts all dbf files data into H2 cache database. */
